...
struct Resource: Codable {
    ...
    var thumbnail: String? {
        if category == .skin { return "https://cdn.storeforminecraft.dev/\(fileHash)" }
        guard let image = images.first else { return nil }
        return "https://image.storeforminecraft.dev/\(image)"
    }
    ...
    init(authorUid: String, basedLanguage: String, category: SFOMCategory, chidCommentsCount: Int?, createdTimestamp: Date, desc: String, downloadCount: Int, fileExt: String, fileHash: String, id: String, images: [String], likeCount: Int, name: String, modifiedTimestamp: Date, state: String, tags: [String], translatedDescs: [String: String], translatedNames: [String: String], translationSource: String, version: Int) {
